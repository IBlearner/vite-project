    ...
    return (
        <div>
            <div className="header">
                <img src="src/assets/LAM SAFETY.png" alt="Driving School" />
                <h1 id="home-title-eng">DUC TINH LAM</h1> 
            </div>
             
            <h1 id="home-title-viet">trang chủ</h1>
            <h2 className="home-heading">heading</h2>
            <p className="home-text">Lorem i like coke Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
